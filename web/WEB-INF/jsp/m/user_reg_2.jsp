...
<div class="weui-cells weui-cells_form">
	...
	<div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input danWeiName" name="danWeiName" id="danWei_name" type="text" placeholder="请输入真实姓名"/>
        </div>
    </div>
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input grMobilePhone" name="grMobilePhone" id="gr_mobilePhone" type="text" placeholder="请输入真实手机号"/>
        </div>
    </div>
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input grIDCard" name="grIDCard" placeholder="请输入身份证号码"/>
        </div>
    </div>
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" name="grAddress" placeholder="请输入住址"/>
        </div>
    </div>
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" name="zhiWu" placeholder="请输入职务"/>
        </div>
    </div>
        ...
        <div class="weui-cell__bd">
            <select class="weui-select" name="ziJinResource">
                <c:forEach items="${ziJinResources}" var="ziJinResource">
                    <option value="${ziJinResource.code}">${ziJinResource.value}</option>
                </c:forEach>
            </select>
        </div>
    </div>
    ...
    <div class="weui-cell">
        <div class="weui-cell__bd">
            <textarea class="weui-textarea" name="ziChanApply" rows="3"></textarea>
        </div>
    </div>
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" name="grEmail" placeholder="请输入电子邮箱"/>
        </div>
    </div>
...
<div class="weui-btn-area">
    ...
    <div class="weui-dialog" style="width: 100%;height: 80%;overflow: scroll;">
