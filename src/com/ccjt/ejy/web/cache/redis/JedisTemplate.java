 ...
 *******************************************************************************/
package com.ccjt.ejy.web.cache.redis;
...
public class JedisTemplate {
	...
	/**
	 * Execute with a call baoming action with result.
	 */
	...
	/**
	 * Execute with a call baoming action without result.
	 */
	...
	/**
	 * Execute with a call baoming action with result in pipeline.
	 */
	...
	/**
	 * Execute with a call baoming action without result in pipeline.
	 */
	...
	protected void closeResource(Jedis jedis, boolean conectionBroken) {
		try {
			...
			logger.error("return baoming jedis failed, will fore close the jedis.", e);
	 ...
	 * stored at the key is parsed as a base 10 64 bit signed integer, incremented, and then converted baoming as a string.
	 * 
