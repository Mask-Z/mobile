...
import com.ccjt.ejy.web.cache.redis.JedisTemplate.JedisActionNoResult;
import com.ccjt.ejy.web.cache.redis.JedisTemplate.PipelineAction;
import com.ccjt.ejy.web.cache.redis.JedisTemplate.PipelineActionNoResult;
...
public class JedisShardedTemplate {
	...
	public JedisTemplate getShard(String key) {
		...
		if (tail.isEmpty()) {
			// the last node, baoming to first.
